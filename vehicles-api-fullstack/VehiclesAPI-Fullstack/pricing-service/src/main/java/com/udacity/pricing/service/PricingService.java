...
public class PricingService {
    ...
    /**
     * Updates a new random price for a given vehicle ID. Its called when the given vehicle ID
     * is deleted in Vehicles API
     * @param vehicleId
     * @throws PriceException
     */
    public static void updatePrice(Long vehicleId) throws PriceException{
